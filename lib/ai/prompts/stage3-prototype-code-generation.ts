...
Respond with a high level description of the changes to be made to the codebase to implement the user's AVS idea or design. Describe each file path and the core changes to be made per that file.
