...
import { appendJSONToHelloWorld as prependHelloWorldToJSON, generateZipFromJSONString, validateCodeProjectJSON } from '../code/generate-code-project';
    ...
    if (intent === UserIntent.GenerateCode) {
      ...
      try {
        ...
        responseText = 'Please download your project code here:\n [**Custom AVS Project Download Link**]('
          + await generateZipFromJSONString(codeProjectJSONString)
